      ...
      <section class="relative py-16 bg-blueGray-200">
        <div class="container mx-auto px-4">
          ...
          >
            <div class="px-6">
              ...
              <div class="text-center mt-12">
                ...
                <div class="mb-2 text-blueGray-600 mt-10">
                  <i
                    class="fas fa-at mr-2 text-lg text-blueGray-400"
                  ></i>
                  {{ profile.email }}
                </div>
                <div class="mb-2 text-blueGray-600">
                  <i
                    class="fas fa-phone mr-2 text-lg text-blueGray-400"
                  ></i>
                  {{ profile.phone }}
                </div>
              </div>
            ...
            <div v-for="(album, index) in profile.albums" :key="index"  class="w-full lg:w-6/12 xl:w-4/12 px-4">
              <div
